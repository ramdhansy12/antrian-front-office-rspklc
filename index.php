                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <h3>Nomor Antrian</h3>
                            <p class="mb-4">Halaman Nomor Antrian digunakan pengunjung untuk mengambil nomor antrian.
                            </p>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-5">
                            ...
                            <p class="mb-4">Halaman Display untuk melihat antrian yang dipanggil oleh petugas.
                            </p>
                            <a href="http://localhost:8080/aplikasi_antrian/display-antrian/display.php"
        ...
        <div class="container-fluid">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2025 - <a href="https://www.instagram.com/_rasya44/" target="_blank"
                    class="text-danger text-decoration-none">Rs.Permata Keluarga Lippo Cikarang</a>. All rights
                reserved.
            </div>
        </div>
    </footer>
